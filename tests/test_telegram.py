...
class TestFormatMessage:
    ...
    def test_error_section_present_when_error_signal(self):
        msg = _format_message([_error_signal()])
    ...
    def test_ticker_appears_in_output(self):
        msg = _format_message([_buy_signal("D05\\.SI")])
        assert "D05" in msg
    ...
    def test_strategy_footer_present(self):
        msg = _format_message([_hold_signal()])
        assert "EMA" in msg
